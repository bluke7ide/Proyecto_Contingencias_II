...
```{r}
primas_h <- sapply(20:70, function(x) calculo_vp(x, degradar_mort(x, 1), 0.07, 0.03))
...
(nivelada[6]*100e6 + 12*(1.5e6*nivelada[4] + 3e6*nivelada[5]))/(12*(nivelada[1]+nivelada[2]+nivelada[3]))
```
